def test_get_existing_meme(get_one_meme_endpoint, create_meme_id):
    ...
    get_one_meme_endpoint.check_id_matches_requested(create_meme_id)
...
def test_get_meme_without_auth(get_one_meme_endpoint, create_meme_id):
    get_one_meme_endpoint.get_one_meme_without_auth(create_meme_id)
